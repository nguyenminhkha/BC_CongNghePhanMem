...
namespace QLi.DAO
{
    public class DataProvider
    {
        ...
        private string connectionSTR = @"workstation id=qlibansach.mssql.somee.com;packet size=4096;user id=minhkha120499_SQLLogin_1;pwd=b8plmzc7fi;data source=qlibansach.mssql.somee.com;persist security info=False;initial catalog=qlibansach";
